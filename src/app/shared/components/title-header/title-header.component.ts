...
import {IBookmarkTask} from '../../../global/types/bookmark/bookmark-task';
...
import {CustomDialogResultEnum} from '../../types/custom-dialog-result.enum';
import {TitleHeaderElement} from './types/title-header-element';
