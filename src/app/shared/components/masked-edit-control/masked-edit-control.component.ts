...
/**
 * Masked edit control - used for editing any type of data using mask
 */
@Component({
  selector: 'cr-control-masked-edit',
  templateUrl: './masked-edit-control.component.html',
  styleUrls: ['./masked-edit-control.component.scss'],
})
export class MaskedEditControlComponent implements OnInit, OnChanges {
  @ViewChild(MaskedTextBoxComponent, {read: TemplateRef}) component: TemplateRef<any>;
